...
const resources = {
  en: {
    translation: {
      ...
      createYourPassSub: 'Please create new password to protect you data in future',
  ...
  vi: {
    translation: {
      ...
      createYourPassSub: 'Vui lòng tạo mật khẩu mới để bảo vệ dữ liệu của bạn trong tương lai',
      repeatNewPass: 'Nhập lại mật khẩu mới',
      repeatNewPassSub: 'Vui lòng nhập lại mật khẩu mới',
      enterYourPass: 'Nhập mật khẩu của bạn',
